...
public class UserController {
    ...
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    public ResponseEntity<?> editMyProfile(@Valid @RequestBody EditAllUser u, @PathVariable UUID id){

        return ResponseEntity.status(HttpStatus.CREATED).body(userService.editUser(u, id));
    }
