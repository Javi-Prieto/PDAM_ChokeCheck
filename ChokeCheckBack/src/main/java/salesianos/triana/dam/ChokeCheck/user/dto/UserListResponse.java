...
@Builder
public record UserListResponse(String id,String name, String surname, String username, String belt, int age, int weight,int height, byte sex,String email) {
    public static UserListResponse of(User u){
