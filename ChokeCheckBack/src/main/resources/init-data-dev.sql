...
insert into post(created_at, type, author_id, id , content , title) values (CURRENT_DATE,  1, '0fa762a2-05bb-44e7-8af4-0ec72107289a', '4f1da3d3-c42b-488b-bba0-af025a5f7dcb', 'Practice more peekaboo style', 'My first advice');

insert into post(created_at, type, author_id, id , content , title ) values (CURRENT_DATE, 0, '1ce9c1c7-7a02-4c7f-bf69-6d0306cbed68', '04a1f811-c826-48aa-a601-7f72bd614303', '3x3min|Jump Ropes,4x3min|Pads,5x3min|Sparring', 'My First Ever Training');
...
insert into post(created_at, type, author_id, id , content , title) values (CURRENT_DATE,  0, 'c2f86ad9-8e2c-448d-92e6-39b25e690ec6', '399e5bd9-933e-4a7f-bdf9-4ca51fd6bcf6', '3x3min|Jump Ropes,4x3min|Pads,5x3min|Sparring', 'My First Ever Training');
...
insert into post(created_at, type, author_id, id , content , title) values (CURRENT_DATE,  1, '1ce9c1c7-7a02-4c7f-bf69-6d0306cbed68', 'ecf22760-db7b-4939-9741-20fa46e46b45', 'Do not jump over 3 min', 'My first advice');
...
insert into post(created_at, type, author_id, id , content , title) values (CURRENT_DATE, 2, '1ce9c1c7-7a02-4c7f-bf69-6d0306cbed68', '4489c36e-8b0f-4d02-8811-a144c678d037', 'Javi just get a new belt', 'My First Ever Upgrade');
